var w = window.innerWidth*0.68*0.95;
   ...
   var svgContainer = d3.select("#mainDesignBubble")
      .style("height", h+"px");

   var svg = d3.select("#mainDesignBubble").append("svg")
        .attr("class", "mainDesignBubbleSVG")
        .attr("width", w)
        .attr("height",h)
   ...
   var mainNote = svg.append("text")
    ...
    d3.json("static/json/design_process.json", function(error, root) {
        console.log(error);
    ...
    svgContainer.style("height",h+"px");
        ...
        //var nSubBubble = Math.floor(root.children[iB].children.length/2.0);
            ...
            .on("mouseover", function(d,i) { // changed on click to mouseover
            ...
            .attr("alignment-baseline", "middle")
                .text(function(d) {return d.name})
                .on("mouseover", function(d,i) { // changed on click child nodes to mousover prevent redirection
                window.open(d.address);
                });
    ...
    resetBubbles = function () {
      ...
      // d3.select("#bubbleItemNote").text("Languages, Frameworks, Libraries, and other web tools I have used");
